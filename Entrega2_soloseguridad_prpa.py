...
class Monitor():
    ...
    def cross_1(self):
        return self.ncar2crossing.value==0 and self.npedcrossing.value==0
    
    def cross_2(self):
        return self.ncar1crossing.value==0 and self.npedcrossing.value==0    
    
    def cross_ped(self):
        return self.ncar2crossing.value==0 and self.ncar1crossing.value==0     
